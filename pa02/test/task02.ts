...
//   in the Camera class.  The goal is to move the ray generation code into Camera.
//   Look in camera.ts and implement the following:
//   1.  Implement the constructor for the Camera class.
//   2.  Implement generateRay
function main() : Image {
    console.log();
    console.log("--------------------------------------------------------");
    console.log("TASK 2: Camera class");
    console.log("--------------------------------------------------------");
...
const img = main();
const file = "img/renders/02_camera_ray_image.png";
